...
router.post('/sendtestmail', async (req, res) => {
  ...
  const trackingPixel = `<img src="http://localhost:5000/track-email-open?emailId=${encodeURIComponent(emailData.to)}&userId=${userId}&campaignId=${campaignId}&t=${Date.now()}" width="1" height="1" style="display:none;" />`;
